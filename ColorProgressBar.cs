...
namespace ColorProgressBar
{
	...
	public class ColorProgressBar : System.Windows.Forms.Control
	{
        ...
        private bool _ShowPercents = true;
        ...
        [Description("ColorProgressBar textpercents")]
        [Category("ColorProgressBar")]
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
            ...
            if (_ShowPercents)
            {
                ...
                using (Font f = new Font(FontFamily.GenericSerif, 12))
                {
                    ...
                    e.Graphics.DrawString(text, f, Brushes.White, location);
                }
            }
		}
